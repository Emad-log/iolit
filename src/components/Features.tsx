export const Features = () => {
  ...
  return (
    <section id="privacy" className="px-6 py-16 bg-secondary/40">
      <div className="max-w-xl mx-auto">
        <h2 className="font-serif text-[28px] tracking-[-0.02em] font-500 mb-2 leading-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
          {guarantees.map((g) => (
            <div key={g} className="flex items-center gap-2.5">
              <svg className="h-4 w-4 text-primary flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
